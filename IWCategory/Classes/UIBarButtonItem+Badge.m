...
- (void)updateBadgeFrame
{
    ...
    self.badge.frame = CGRectMake(self.badgeOriginX-8, self.badgeOriginY+8, minWidth + padding, minHeight + padding);
...
+ (UIBarButtonItem *)itemWithTitle:(NSString *)title  titleColor:(UIColor *)titleColor font:(UIFont*)font target:(id)target action:(SEL)action{
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
